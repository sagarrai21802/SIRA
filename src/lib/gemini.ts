...
// // // 🖼️ New Function for Image Generation with Gemini
...
// //             // Fix: Add a check to ensure inlineData exists before accessing it
...
//   try {
//     const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyBdZXnuzoZfqi59189qXkgUNzZm_moOmCY`, {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
...
//         model: 'gemini-2.0-flash-preview-image-generation',
//         generationConfig: {
//             // Fix: 'responseMimeTypes' is not a valid property. The correct one is 'responseMimeType' (singular).
