...
const CopyableOutput = ({ title, body, cta }: { title: string; body: string; cta: string }) => {
  ...
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-pink-50 via-yellow-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 p-6 shadow-lg border border-pink-100 dark:border-gray-700">
      {/* Copy button */}
      <Button
        size="sm"
        variant="ghost"
        className="absolute top-3 right-3 text-gray-500 hover:text-gray-900 dark:hover:text-gray-200"
        onClick={handleCopy}
      >
        {copied ? <Check className="h-5 w-5 text-green-500" /> : <Copy className="h-5 w-5" />}
      </Button>
      ...
      {/* Body */}
      <div className="bg-white/70 dark:bg-gray-900/50 p-4 rounded-xl shadow-inner mb-4">
      ...
      {/* CTA */}
      <div className="mt-4 p-3 bg-gradient-to-r from-pink-500 to-yellow-400 rounded-xl text-center shadow-md">
