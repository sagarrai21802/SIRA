                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {images.map((image, idx) => (
                              <div key={idx} className="relative group rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-md hover:shadow-lg transition-all duration-300">
                                <img onClick={() => openImagePreview(image)} src={image} alt={`Generated Facebook Post ${idx + 1}`} className="w-full h-28 object-cover cursor-zoom-in" />
              ...
              <CardContent className="p-8 space-y-8">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-200">🚀 Generated Facebook Post</h3>
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      placeholder="Describe what to change or add (e.g., 'make the tone more engaging, add a question to encourage comments, and include 2 relevant hashtags at the end')"
                      className="w-full p-3 rounded-xl border border-slate-300/60 dark:border-slate-600/60 bg-white/50 dark:bg-slate-900/50 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 min-h-[90px]"
                    />
                  ...
                  {isEditing ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          className="w-full p-3 rounded-xl border border-slate-300/60 dark:border-slate-600/60 bg-white/50 dark:bg-slate-900/50 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 hover:shadow-md min-h-[140px] resize-y"
                          value={editedBody}
                ...
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white dark:bg-slate-900 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full p-3 rounded-xl border border-slate-300/60 dark:border-slate-600/60 bg-white/50 dark:bg-slate-900/50 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 min-h-[120px]"
                    />
                  </div>
